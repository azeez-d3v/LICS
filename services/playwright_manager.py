...
# Singleton instance to be shared across scrapers
playwright_manager = PlaywrightManager()

async def get_with_playwright(url, wait_for_selector=None, wait_time=5000):
    """
    Utility function to get HTML content from a page using Playwright.
    ...
    Returns:
        str: The HTML content of the page after JavaScript has loaded
    """
    return await playwright_manager.get_page_content(url, wait_for_selector, wait_time)
